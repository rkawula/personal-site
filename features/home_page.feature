...
Given that there is a post in the database with title "First post" and body "Hello world!" in the blog
When I visit the home page
Then I should see the title "First post" and body "Hello world!"
